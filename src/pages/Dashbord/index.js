        ...
        <>
            <div className="right-content w-100">
                <div className="row dashbordBoxWrapperRow">
                    ...
                    <div className="col-md-5 pl-0">
                        <div className="box graphBox">
                            ...
                            <h3 className="text-white font-weight-bold"> Birr 465,768,798</h3>
                            <p>Birr 3,458,23 in last month</p>
                ...
                <div className="card shadow border-0 p-3 mt-4">
                    <h3 className="hd">Best Selling Branches</h3>
                                    ...
                                    <td>
                                        <div className="d-flex align-item-center productBox w-auto">
                                            <div className="imgWrapper">
                                                <div className="img">
                                                    <img src="https://i.pinimg.com/736x/33/62/bb/3362bbf15c211906e376713e12f38fbf.jpg" className="w-100" alt="Product"/>
                                                </div>
                                            </div>
                                            <div className="info">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className="d-flex align-item-center productBox">
                                            <div className="imgWrapper">
                                                <div className="img">
                                                    <img src="https://i.pinimg.com/736x/92/b5/aa/92b5aa81653ea91b455d034267144916.jpg" className="w-100" alt="Product"/>
                                                </div>
                                            </div>
                                            <div className="info">
